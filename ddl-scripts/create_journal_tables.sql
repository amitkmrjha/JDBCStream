...
CREATE INDEX IF NOT EXISTS CONCURRENTLY state_tag_idx on public.durable_state (tag);
CREATE INDEX IF NOT EXISTS CONCURRENTLY state_global_offset_idx on public.durable_state (global_offset);